...
def process_single_parameter(sample_num, thresh_adj_mult, data_dir, output_root_dir, 
                           sigma_value=10, min_obj_size=5000, overlap_thresh=0.1, 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--overlap_thresh', type=float, default=0.1, help='Overlap threshold for region classification')
